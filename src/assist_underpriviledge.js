...
function AssistLessPriviledge() {
  return (
   <div className="container">
     <div className="row">
        <div className="col-6">
     <img style={{width:"100%",padding:"10%",border:"2px solid grey"}} src={require(`./groupchildren.jpg`)} />
        </div>
        <div className="col-6" style={{alignSelf:"center"}}>
         <div>
            <h2 className="header_text">
                Help ALtruistic children
            </h2>
    ...
    <center>
        <h1 className="header_text" style={{textDecoration:"underline"}}>Who Are Under Priviledged ?</h1>
     </center>
    </div>
     </div>
     ...
     <div className="col-12" style={{padding:"30px"}}>
        <center>
            <img src={require(`./cryingbaby.jpg`)} style={{width:'50%',borderRadius:"50%",border:"20px solid lightblue"}} />
        </center>
     </div>
     <div className="col-12">
...
export default AssistLessPriviledge;
