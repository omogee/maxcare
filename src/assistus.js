...
function Assistus() {
  return (
   <div className="container">
     <div className="row">
        <div className="col-6">
     <img style={{width:"100%",padding:"10%",borderRadius:"50%"}} src={require(`./children.jpg`)} />
        </div>
    ...
    <center>
        <h1 className="header_text" style={{textDecoration:"underline"}}>Who are ALtruistic Children and why do they need our help</h1>
     </center>
    </div>
     </div>
   <div className="container">
